...
Visit the project's [GitHub repo](https://github.com/The-AI-Alliance/AIA-NAIRR-Pilots/){:target="repo"} and the [open issues](https://github.com/The-AI-Alliance/AIA-NAIRR-Pilots/issues){:target="issues"} to find areas where help is needed. We welcome [pull requests](https://github.com/The-AI-Alliance/AIA-NAIRR-Pilots/pulls){:target="prs"} and suggestions as [new issues](https://github.com/The-AI-Alliance/AIA-NAIRR-Pilots/issues){:target="issues"}.
...
In the &ldquo;Message&rdquo; box mention this project, **AI Alliance and NAIRR Pilot Projects**, and add anything else you would like us to know.
...
The sources for this website are in the GitHub repo's [`docs`](https://github.com/The-AI-Alliance/AIA-NAIRR-Pilots/tree/main/docs){:target="repo-docs"} directory. 
